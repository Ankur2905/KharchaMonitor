...
public class AuthService {
    ...
    public DTO<String> register(User user) {
    ...
    //Verify OTP
    public DTO<String> verifyOtp(String email, String otp) {
    ...
    public DTO<String> forgotPassword(String email) {
        User user =userRepository.findByEmail(email);
        if(user == null){
            return new DTO<>("Email not found",false);
        }
    ...
    public DTO<String> resetPassword(String email, String resetToken, String newPassword) {
